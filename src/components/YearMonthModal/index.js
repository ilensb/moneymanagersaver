        ...
        <View>
          <View>
            <View style={{ flexDirection: 'row' }}>
              ...
              >
                <IonIcons
                  name={Icons.IonIcons.arrowForward}
                  size={20}
                  color="#fff"
                />
              </TouchableOpacity>
            ...
            {data.map(({ fullMonth, abbr, num }, i) => {
              return (
                ...
                >
                  <View
                    style={[
                      styles.dateModalView,
                      isMonthActive(num) ? styles.selectedDateModalView : null,
                    ]}
                  >
                    <Text
                      style={[
                        ...
                        isMonthActive(num)
                          ? styles.selectedDateModalViewText
                          : null,
                      ]}
                    >
                      {abbr}
