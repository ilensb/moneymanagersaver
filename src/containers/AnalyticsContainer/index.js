...
import { TopBar, EmptyDataWithButton, YearMonthModal } from '../../components';
      ...
      <View style={{ flexDirection: 'row', paddingTop: 15 }}>
        <View style={{ flex: 1 }}>
          <View style={[styles.imageView, { backgroundColor: c }]}>
            <Image source={Images[x]} style={styles.image} />
          </View>
        </View>
        <View
          style={{
    ...
    return (
      <View style={{ backgroundColor: '#EEEEEE', flex: 1 }}>
        ...
        <YearMonthModal
          ...
          onMonthPressed={(num, fullMonth) =>
            this.onMonthPressed(num, fullMonth)
          }
...
function TransactionTypeButton({ onIncomePress, onExpensePress, activeType }) {
  return (
    <View style={styles.transactionTypeButtonView}>
      <View style={styles.transactionTypeButtons}>
        <TouchableOpacity
          ...
          style={[
            styles.transactiontypeView,
            activeType('Expense') ? styles.selectedTransactionTypeView : null,
          ]}
        >
          <Text
            style={[
              styles.transactionTypeText,
              activeType('Expense') ? styles.selectedTransactionTypeText : null,
            ]}
          >
            Expense
          </Text>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.transactiontypeView,
            activeType('Income') ? styles.selectedTransactionTypeView : null,
          ]}
        >
          <Text
            style={[
              styles.transactionTypeText,
              activeType('Income') ? styles.selectedTransactionTypeText : null,
            ]}
          >
            Income
          </Text>
...
function TransactionTypeCharts({ chartData, labelData }) {
  return (
...
function CategoryWiseData({ transactionType, categoryData, renderItem }) {
  return (
